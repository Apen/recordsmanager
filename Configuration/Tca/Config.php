...
$TCA['tx_recordsmanager_config'] = array(
    ...
    'columns'     => array(
        ...
        'insertchoosepid'   => array(
            'exclude' => 0,
            'label'   => 'LLL:EXT:recordsmanager/Resources/Private/Language/locallang_db.xml:tx_recordsmanager_config.insertchoosepid',
            'config'  => array(
                'type'    => 'check',
                'default' => '0',
            )
    ...
    'types'       => array(
        ...
        '2' => array('showitem' => 'hidden;;1;;1-1-1, title;;;;2-2-2, type;;;;2-2-2, sqltable;;;;3-3-3, exportmode, sqlfields, extrawhere, extragroupby, extraorderby, extralimit, exportfilterfield, dateformat, permsgroup, excludefields, extrats'),
